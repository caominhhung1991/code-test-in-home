...
import {useLocale} from '@caominhhung1991/components'
...
const data: Data = {
  all: [
    {name: {en_US: 'appliances', vi_VN: 'appliances'}, value: 4544},
    {name: {en_US: 'drinks', vi_VN: 'drinks'}, value: 3321},
    {name: {en_US: 'health', vi_VN: 'health'}, value: 3113},
    {name: {en_US: 'clothing', vi_VN: 'clothing'}, value: 2341},
    {name: {en_US: 'baby', vi_VN: 'baby'}, value: 1231},
    {name: {en_US: 'others', vi_VN: 'others'}, value: 132}
  ],
  online: [
    {name: {en_US: 'appliances', vi_VN: 'appliances'}, value: 244},
    {name: {en_US: 'drinks', vi_VN: 'drinks'}, value: 231},
    {name: {en_US: 'health', vi_VN: 'health'}, value: 311},
    {name: {en_US: 'clothing', vi_VN: 'clothing'}, value: 41},
    {name: {en_US: 'baby', vi_VN: 'baby'}, value: 121},
    {name: {en_US: 'others', vi_VN: 'others'}, value: 111}
  ],
  offline: [
    {name: {en_US: 'appliances', vi_VN: 'appliances'}, value: 99},
    {name: {en_US: 'drinks', vi_VN: 'drinks'}, value: 188},
    {name: {en_US: 'health', vi_VN: 'health'}, value: 344},
    {name: {en_US: 'clothing', vi_VN: 'clothing'}, value: 255},
    {name: {en_US: 'others', vi_VN: 'others'}, value: 65}
  ]
}
