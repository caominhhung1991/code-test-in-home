...
import {MyTable} from '@caominhhung1991/components'
...
const BasePage = <S extends SearchApi>(props: PageProps<S>, ref: React.Ref<RefPageProps>) => {
  ...
  const onPageChange = (pageNum: number, pageSize?: number) => {
    setPageData({pageNum})
    if (pageSize) setPageData({pageSize})
  }
    ...
    <div css={pageStyles}>
      ...
      <div className="tabs-main">
        ...
        <div className="aside-main">
          {searchRender && <MySearch className="search" onSearch={onSearch}>{searchRender}</MySearch>}

          {
            radioCardsData && <MyRadioCards
          ...
          {
            tableOptions && <div className="table">
              <MyTable
                height="100%"
...
const BasePageRef = forwardRef(BasePage) as <S extends SearchApi>(props: PageProps<S> & {ref?: React.Ref<RefPageProps>})
  => React.ReactElement
...
export const MyPage = BasePageRef as MyPageType
